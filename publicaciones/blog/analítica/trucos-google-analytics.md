...
Google Analytics es seguramente una de las **plataformas de analítica web más utilizadas** en el mundo. Su versión gratuita, facilidad de implementacón y de uso hace que prácticamente cualquier página pueda comenzar a usarla sin apenas tener conocimientos técnicos o de análisis de datos.

A continuación mostramos una serie de trucos y aspectos importantes a tener en cuenta dentro de una implementación de Google Analytics para obtener el mejor rendimiento y resultados posibles.
...
Si además usas Google Sheets para consolidar tus informes, te vendrán bien estos [10 trucos para hojas de cálculo de Google](https://emirodgar.com/trucos-hojas-calculo-google).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5MDEyMzI0OSwtMjkwMzAwMzI2LC03NT
Y3MTE5MDBdfQ==
-->