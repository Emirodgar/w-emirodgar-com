...
Lo que pocas veces se indica es que estas etiquetas sólo sirven para **Google Search Appliance**, es decir cuando instalamos el buscador de Google en nuestro servidor para realizar búsquedas sobre nuestros documentos. De ahí que nos permitan identificar mediante estas etiquetas qué partes podrán ser indexadas y cuáles no.

Para el motor de búsqueda de Google estas etiquetas no tienen ningún impacto.
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzI3NTEwMTExLDQ2Mjg4MzUyOV19
-->